...
# python extract_gene_from_whole_genome.py --genbank_file ../ingest/data/references/229E_full_reference.gb --output_directory ../data/references --product_names "spike protein" "membrane protein" "nucleocapsid protein"
...
# Input GenBank file
#genbank_file = "../ingest/data/references/229E_full_reference.gb"
